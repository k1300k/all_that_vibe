...
export default function ProgramInfoModal() {
    ...
    const versions = [
        ...
        },
        {
            version: 'v0.5',
            date: '2025-11-25',
            title: 'Week 5 Service Flow 통합',
            userPrompt: '단계별 항목들을 아래의 깃허브 내용에서 가져와 주세요 (newday repository)',
            features: [
                'Week 5: Service Flow 7개 신규 템플릿 추가',
            ...
            technical: [
                'newday 저장소 체크리스트 통합',
                'planning & flow 카테고리 추가',
                'config/mcpTemplates.ts 확장',
                'store/useFlowStore.ts 대폭 업데이트',
                '사이드바 Week 5 섹션 추가',
                '헤더: 5주 커리큘럼 · 22 MCPs',
            ],
        },
